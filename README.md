...
- 🚀 AI-Powered Marketing Automation with:
  - Multi-channel content generation (Blog, Social Media, Email)
  - Advanced AI models from OpenAI, Hugging Face, and Replicate
  - Intelligent scheduling and coordination
  - Real-time performance analytics
  - Bot integration for Telegram and WhatsApp
...
The project includes a powerful AI-driven marketing automation system. To set it up:

1. Configure AI providers in your `.env.local`:
```shell
...
2. Navigate to `/dashboard/settings/ai-models` to:
   - Add your API keys
   - Configure custom AI models
   - Set up model parameters

3. Access the marketing automation dashboard at `/dashboard/marketing/automation` to:
   - Create marketing flows
   - Configure channels
   - Set up scheduling
   - Monitor performance

For detailed configuration and usage instructions, refer to the [HOWTO.md](HOWTO.md) file.
